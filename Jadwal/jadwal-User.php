...
<div id="content-wrapper">
	<div class="container-fluid pb-0">
		...
		<div class="container" >  
			<i class="fas fa-film fa-4x" style="color:#C70039;"> Cooming Soon Movie With Table</i>
	...
	$query = "SELECT * FROM jadwalmov"; // Query untuk menampilkan semua data siswa
	$sql = mysqli_query($connect, $query); // Eksekusi/Jalankan query dari variabel $query
	
	while($data = mysqli_fetch_array($sql)){ // Ambil semua data dari hasil eksekusi $sql
		echo "<tr>";
		echo "<td><img src='images/".$data['foto']."' width='200' height='250' padding:'5px'></td>";
...
<div class="container">
	<button type="button" value="showAlert" onclick="showAlert();" class="btn btn-success" id="success">Add Data</button>
	<div class="alert alert-warning alert-dismissable" id="myAlert2">
            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
            LOGIN AS ADMIN TO ADD DATA!
        </div>
